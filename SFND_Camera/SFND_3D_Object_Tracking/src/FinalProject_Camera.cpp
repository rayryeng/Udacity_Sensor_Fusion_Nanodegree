...
// SHITOMASI, BRISK, MAT_BF, DES_BINARY, SEL_NN, bVis=true, bLimitKpts=false
...
int main(int argc, const char* argv[]) {
  ...
  // Changed so that we already use the committed weights via Git-LFS
  // The original repo had these weights committed too but I don't want
  // to increase the size of the repo
  string yoloBasePath = "../../detect_objects/dat/yolo/";
  ...
  for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex;
    ...
    // Edited by Ray to implement ring buffer
