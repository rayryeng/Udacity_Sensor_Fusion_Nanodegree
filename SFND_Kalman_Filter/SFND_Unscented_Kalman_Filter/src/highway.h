...
class Highway {
 public:
  ...
  Highway(pcl::visualization::PCLVisualizer::Ptr& viewer) {
    ...
    egoCar =
        Car(Vect3(0, 0, 0), Vect3(4, 2, 2), Color(0, 1, 0), 0, 0, 2, "egoCar");
    ...
    Car car2(Vect3(25, -4, 0), Vect3(4, 2, 2), Color(0, 0, 1), -6, 0, 2,
             "car2");
  ...
  void stepHighway(double egoVelocity,
    ...
    if (visualize_pcd) {
      pcl::PointCloud<pcl::PointXYZ>::Ptr trafficCloud =
          tools.loadPcd("../src/sensors/data/pcd/highway_" +
                        std::to_string(timestamp) + ".pcd");
      renderPointCloud(
          viewer, trafficCloud, "trafficCloud",
